...
const FeedBackPage = () => {
    ...
    const fetchData = ({ currentPage, pageSize = DefaultPaginationSettings.ROWS_PER_PAGE, search }) => {
        ...
        axiosInstance
            .get(ApiEndPoints.FEEDBACK.list, { params })
            .then(response => {
                setcareerData(response.data.data.feedback)
    ...
    const onConfirmDelete = useCallback(
        e => {
            ...
            axiosInstance
                .delete(ApiEndPoints.FEEDBACK.delete(careerToDelete._id))
