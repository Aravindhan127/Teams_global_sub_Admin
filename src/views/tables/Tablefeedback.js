        ...
        columns={[
            {
                ...
                sortable: false,
                headerName: 'Question',
                renderCell: ({ row }) => <Typography noWrap variant='body2' title={row.questions}>
                    {row.questions}
                </Typography>
            },
            {
                ...
                renderCell: ({ row }) => <Typography noWrap variant='body2' title={row?.keywords?.name}>
                    {row?.keywords?.map(item => item?.name).join(', ')}
                </Typography>
            },
            {
                field: 'updatedAt',
